...
var asLoader = function asLoader() {
  ...
  var init = function init() {
    ...
    if (!args['location']) {
      ...
      if (args['location'].length !== 4 && args['locationType'] === 'custom') {
        setDefualtLocation();
      } else {
  ...
  this.start = function () {
    ...
    if (args['locationType'] === 'custom') {
      ...
      // TODO FIX
      style += 'position:absolute;top:0;right:0;bottom:null;left:0;'; // args.location.forEach((loc, idx, arr) => {
  ...
  this.success = function () {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        void 0;
        loaderEle.parentElement.removeChild(loaderEle); // document.body.removeChild(loaderEle);
